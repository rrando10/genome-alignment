...
This program computes the local alignment score of two sequences
...
def fill(T,A,s,t):
    ...
    for i in range(1,len(s)+1):
        for j in range(1,len(t)+1):
            ...
            #record optimal score and location
            if(T[i][j] >= optimal):
                optimal = T[i][j]
                opt_i = i
                opt_j = j
    
    #return score, coords, and the filled matrices
    return T,A,optimal,opt_i,opt_j
...
def print_alignment(A,s,t,opt_i,opt_j):
...
def main():
    ...
    #argument check
    if(len(sys.argv) != 3):
        print("Usage: python3 localign.py seq1.fasta seq2.fasta")
        sys.exit()
    ...
    T,A = initialize(n,m)
    T,A,optimal,opt_i,opt_j = fill(T,A,s,t)
    print_alignment(A,s,t,opt_i,opt_j)
    
    print("\nOptimal Alignment Score:",optimal)
    print()
